...
#
# Generated by export_simulation on Thu Aug 11 14:32:39 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './axi_crossbar_0.sh' script.

./axi_crossbar_0.sh -reset_run
...
./axi_crossbar_0.sh -noclean_files

For more information on the script, please type './axi_crossbar_0.sh -help'.
